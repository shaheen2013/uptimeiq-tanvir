...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h1 class="h4 text-truncate mb-0"><?= sprintf(l('monitor_update.header'), $data->monitor->name) ?></h1>
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <select id="type" name="type" class="form-control" required="required">
                        <option value="website" <?= $data->monitor->type == 'website' ? 'selected="selected"' : null ?>><?= l('monitor.input.type_website') ?></option>
                        <option value="ping" <?= $data->monitor->type == 'ping' ? 'selected="selected"' : null ?>><?= l('monitor.input.type_ping') ?></option>
                        <option value="port" <?= $data->monitor->type == 'port' ? 'selected="selected"' : null ?>><?= l('monitor.input.type_port') ?></option>
                    </select>
                ...
                <div class="form-group custom-control custom-switch">
                    ...
                    <small class="form-text text-muted"><?= l('monitor.input.is_enabled_help') ?></small>
                </div>
                ...
                <div class="collapse" id="custom_request_container">
                    <div data-type="website">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="request_body" name="request_body" maxlength="8192" class="form-control"><?= $data->monitor->settings->request_body ?></textarea>
                ...
                <div class="collapse" id="custom_response_container">
                    <div data-type="website">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="response_status_code" name="response_status_code" min="0" max="1000" class="form-control" value="<?= $data->monitor->settings->response_status_code ?>" required="required" />
                        </div>

                        <div class="form-group">
                            <label for="response_body"><?= l('monitor.input.response_body') ?></label>
                            <textarea id="response_body" name="response_body" maxlength="8192" class="form-control"><?= $data->monitor->settings->response_body ?></textarea>
