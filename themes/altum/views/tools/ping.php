    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    <label for="ping_server_id"><i class="fa fa-fw fa-sm fa-map-marked-alt text-muted mr-1"></i> <?= l('tools.ping.ping_server_id') ?></label>
                    <select id="ping_server_id" name="ping_server_id" class="form-control" required="required">
                        <?php foreach($data->ping_servers as $ping_server): ?>
                        <option value="<?= $ping_server->ping_server_id ?>" <?= $data->values['ping_server_id'] == $ping_server->ping_server_id ? 'selected="selected"' : null ?>><?= get_countries_array()[$ping_server->country_code] . ' - ' . $ping_server->city_name ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
