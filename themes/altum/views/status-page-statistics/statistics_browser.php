    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex align-items-center">
                <h3 class="h5 text-truncate m-0"><?= l('status_page_statistics.statistics.browser') ?></h3>

                <div class="ml-2">
                    <span data-toggle="tooltip" title="<?= l('status_page_statistics.statistics.browser_help') ?>">
