...
<div>
    ...
    <div class="form-group">
        ...
        <textarea id="head_js_status_page" name="head_js_status_page" class="form-control"><?= settings()->custom->head_js_status_page ?></textarea>
    </div>
    ...
    <div class="form-group">
        ...
        <textarea id="head_css_status_page" name="head_css_status_page" class="form-control"><?= settings()->custom->head_css_status_page ?></textarea>
    </div>
</div>
