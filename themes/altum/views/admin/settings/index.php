    ...
    <div class="mb-3 mb-xl-5 mb-xl-0 col-12 col-xl-4">
        <div class="d-xl-none">
            <select name="settings_menu" class="form-control">
                ...
                <option value="<?= url('admin/settings/monitors_heartbeats') ?>" class="nav-link" <?= $data->method == 'monitors_heartbeats' ? 'selected="selected"' : null ?>><?= l('admin_settings.monitors_heartbeats.tab') ?></option>
        ...
        <div class="card d-none d-xl-flex">
            <div class="card-body">
                <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link <?= $data->method == 'status_pages' ? 'active' : null ?>" href="<?= url('admin/settings/status_pages') ?>"><i class="fa fa-fw fa-sm fa-wifi mr-1"></i> <?= l('admin_settings.status_pages.tab') ?></a>
                    <a class="nav-link <?= $data->method == 'monitors_heartbeats' ? 'active' : null ?>" href="<?= url('admin/settings/monitors_heartbeats') ?>"><i class="fa fa-fw fa-sm fa-server mr-1"></i> <?= l('admin_settings.monitors_heartbeats.tab') ?></a>
