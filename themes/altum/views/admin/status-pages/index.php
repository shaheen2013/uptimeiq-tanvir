...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 mb-3 mb-md-0"><i class="fa fa-fw fa-xs fa-wifi text-primary-900 mr-2"></i> <?= l('admin_status_pages.header') ?></h1>
                ...
                <div class="dropdown-menu dropdown-menu-right filters-dropdown">
                    <div class="dropdown-header d-flex justify-content-between">
                        ...
                        <?php if(count($data->filters->get)): ?>
                            <a href="<?= url('admin/status_pages') ?>" class="text-muted"><?= l('global.filters.reset') ?></a>
                        <?php endif ?>
                    </div>
                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="order_by" id="filters_order_by" class="form-control form-control-sm">
                                ...
                                <option value="name" <?= $data->filters->order_by == 'name' ? 'selected="selected"' : null ?>><?= l('admin_status_pages.table.name') ?></option>
                                <option value="pageviews" <?= $data->filters->order_by == 'pageviews' ? 'selected="selected"' : null ?>><?= l('admin_status_pages.table.pageviews') ?></option>
                            </select>
                        </div>
...
<form id="table" action="<?= SITE_URL . 'admin/status-pages/bulk' ?>" method="post" role="form">
    ...
    <table class="table table-custom">
        ...
        <tr>
            ...
            <th><?= l('admin_status_pages.table.user') ?></th>
            <th><?= l('admin_status_pages.table.name') ?></th>
            <th><?= l('admin_status_pages.table.pageviews') ?></th>
            <th><?= l('admin_status_pages.table.is_enabled') ?></th>
            <th></th>
            <th></th>
        </tr>
        </thead>
