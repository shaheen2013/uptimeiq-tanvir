                    ...
                    <tr>
                        ...
                        <td>
                            <select class="user_role custom-select custom-select-sm" name="role_type" user_id="<?= $row->user_id ?>">
                                <option value="1" <?= $row->type==1? 'selected':'' ?> >Site admin</option>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" target_url="<?php echo url('admin/users/roleChange') ?>" id="roleChangeModalConfirm">Confirm</button>
      </div>
    </div>
  </div>
</div>
