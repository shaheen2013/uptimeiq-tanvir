...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 mb-3 mb-md-0"><i class="fa fa-fw fa-xs fa-network-wired text-primary-900 mr-2"></i> <?= l('admin_domain_names.header') ?></h1>
        ...
        <div class="">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right d-print-none">
                    <a href="<?= url('admin/domain-names?' . $data->filters->get_get() . '&export=csv') ?>" target="_blank" class="dropdown-item">
                        <i class="fa fa-fw fa-sm fa-file-csv mr-1"></i> <?= sprintf(l('global.export_to'), 'CSV') ?>
                    </a>
                    <a href="<?= url('admin/domain-names?' . $data->filters->get_get() . '&export=json') ?>" target="_blank" class="dropdown-item">
                ...
                <div class="dropdown-menu dropdown-menu-right filters-dropdown">
                    <div class="dropdown-header d-flex justify-content-between">
                        ...
                        <?php if(count($data->filters->get)): ?>
                            <a href="<?= url('admin/domain-names') ?>" class="text-muted"><?= l('global.filters.reset') ?></a>
                        <?php endif ?>
                    </div>
                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="order_by" id="filters_order_by" class="form-control form-control-sm">
                                ...
                                <option value="name" <?= $data->filters->order_by == 'name' ? 'selected="selected"' : null ?>><?= l('admin_domain_names.table.name') ?></option>
                                <option value="target" <?= $data->filters->order_by == 'target' ? 'selected="selected"' : null ?>><?= l('admin_domain_names.table.target') ?></option>
                            </select>
                        </div>
    ...
    <div class="table-responsive table-custom-container">
        <table class="table table-custom">
            ...
            <tr>
                ...
                <th><?= l('admin_domain_names.table.user') ?></th>
                <th><?= l('admin_domain_names.table.domain_name') ?></th>
                <th><?= l('admin_domain_names.table.is_enabled') ?></th>
                <th></th>
                <th></th>
            </tr>
            </thead>
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex flex-column">
                            ...
                            <div class="text-muted">
                                <img src="https://external-content.duckduckgo.com/ip3/<?= $row->target ?>.ico" class="img-fluid icon-favicon mr-1" />
                                <span><?= $row->target ?></span>
                                <a href="<?= 'https://' . $row->target ?>" target="_blank" rel="noreferrer"><i class="fa fa-fw fa-xs fa-external-link-alt ml-1"></i></a>
                            </div>
                        </div>
                    </td>
                    <td class="text-nowrap">
