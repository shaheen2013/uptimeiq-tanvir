        ...
        <div class="card">
            <div class="card-body">
                <div class="nav flex-column nav-pills">
                    ...
                    <a class="nav-link <?= $data->type == 'monitors' ? 'active' : null ?>" href="<?= url('admin/statistics/monitors?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-server mr-1"></i> <?= l('admin_statistics.monitors.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'monitors_logs' ? 'active' : null ?>" href="<?= url('admin/statistics/monitors_logs?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-signal mr-1"></i> <?= l('admin_statistics.monitors_logs.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'heartbeats' ? 'active' : null ?>" href="<?= url('admin/statistics/heartbeats?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-heartbeat mr-1"></i> <?= l('admin_statistics.heartbeats.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'heartbeats_logs' ? 'active' : null ?>" href="<?= url('admin/statistics/heartbeats_logs?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-chart-bar mr-1"></i> <?= l('admin_statistics.heartbeats_logs.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'domain_names' ? 'active' : null ?>" href="<?= url('admin/statistics/domain_names?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-network-wired mr-1"></i> <?= l('admin_statistics.domain_names.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'status_pages' ? 'active' : null ?>" href="<?= url('admin/statistics/status_pages?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-wifi mr-1"></i> <?= l('admin_statistics.status_pages.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'notification_handlers' ? 'active' : null ?>" href="<?= url('admin/statistics/notification_handlers?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-bell mr-1"></i> <?= l('admin_statistics.notification_handlers.menu') ?></a>
