...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4"><i class="fa fa-fw fa-bell fa-xs text-muted"></i> <?= l('admin_statistics.notification_handlers.header') ?></h2>
        <div class="d-flex flex-column flex-xl-row">
            <div class="mb-2 mb-xl-0 mr-4">
                <span class="font-weight-bold"><?= nr($data->total['notification_handlers']) ?></span> <?= l('admin_statistics.notification_handlers.chart') ?>
            </div>
        </div>
...
<script>
    ...
    new Chart(notification_handlers_chart, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: <?= json_encode(l('admin_statistics.notification_handlers.chart')) ?>,
