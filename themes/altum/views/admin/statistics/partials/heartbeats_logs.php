...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4"><i class="fa fa-fw fa-chart-bar fa-xs text-muted"></i> <?= l('admin_statistics.heartbeats_logs.header') ?></h2>
        <div class="d-flex flex-column flex-xl-row">
            <div class="mb-2 mb-xl-0 mr-4">
                <span class="font-weight-bold"><?= nr($data->total['heartbeats_logs']) ?></span> <?= l('admin_statistics.heartbeats_logs.chart') ?>
            </div>
        </div>
