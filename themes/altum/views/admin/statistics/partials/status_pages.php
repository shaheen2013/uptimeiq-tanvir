...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4"><i class="fa fa-fw fa-wifi fa-xs text-muted"></i> <?= l('admin_statistics.status_pages.header') ?></h2>
        <div class="d-flex flex-column flex-xl-row">
            <div class="mb-2 mb-xl-0 mr-4">
                <span class="font-weight-bold"><?= nr($data->total['status_pages']) ?></span> <?= l('admin_statistics.status_pages.chart') ?>
            </div>
        </div>
...
<script>
    ...
    new Chart(status_pages_chart, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: <?= json_encode(l('admin_statistics.status_pages.chart')) ?>,
