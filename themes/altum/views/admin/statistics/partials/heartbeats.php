...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4"><i class="fa fa-fw fa-heartbeat fa-xs text-muted"></i> <?= l('admin_statistics.heartbeats.header') ?></h2>
        <div class="d-flex flex-column flex-xl-row">
            <div class="mb-2 mb-xl-0 mr-4">
                <span class="font-weight-bold"><?= nr($data->total['heartbeats']) ?></span> <?= l('admin_statistics.heartbeats.chart') ?>
            </div>
        </div>
...
<script>
    ...
    new Chart(heartbeats_chart, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: <?= json_encode(l('admin_statistics.heartbeats.chart')) ?>,
