    ...
    <div class="admin-sidebar-links-wrapper">
        <ul class="admin-sidebar-links">
            ...
            <?php if(\Altum\Plugin::is_active('teams')): ?>
                <li class="<?= \Altum\Router::$controller == 'AdminTeams' || \Altum\Router::$controller == 'AdminTeamCreate' || \Altum\Router::$controller == 'AdminTeamMemberInvite' || \Altum\Router::$controller =='AdminTeamInvitation' ? 'active' : null ?>">
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminMonitors']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/monitors') ?>">
                    <i class="fa fa-fw fa-sm fa-server mr-2"></i> <?= l('admin_monitors.menu') ?>
                </a>
            </li>
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminHeartbeats']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/heartbeats') ?>">
                    <i class="fa fa-fw fa-sm fa-heartbeat mr-2"></i> <?= l('admin_heartbeats.menu') ?>
                </a>
            </li>
            
            <!-- threshold menu entry begin  -->
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminThresholds']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/thresholds') ?>">
                    <i class="fa fa-fw fa-sm fa-tachometer-alt mr-2"></i> <?= l('admin_thresholds.menu') ?>
                </a>
            </li>
            <!-- threshold menu entry end -->
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminDomainNames']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/domain-names') ?>">
                    <i class="fa fa-fw fa-sm fa-network-wired mr-2"></i> <?= l('admin_domain_names.menu') ?>
                </a>
            </li>
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminStatusPages']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/status-pages') ?>">
                    <i class="fa fa-fw fa-sm fa-wifi mr-2"></i> <?= l('admin_status_pages.menu') ?>
                </a>
            </li>
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminPingServers', 'AdminPingServerCreate', 'AdminPingServerUpdate']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/ping-servers') ?>">
                    <i class="fa fa-fw fa-sm fa-map-marked-alt mr-2"></i> <?= l('admin_ping_servers.menu') ?>
                </a>
            </li>
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminNotificationHandlers']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/notification-handlers') ?>">
                    <i class="fa fa-fw fa-sm fa-bell mr-2"></i> <?= l('admin_notification_handlers.menu') ?>
                </a>
            </li>
