    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div <?= \Altum\Teams::get_main_user()->plan_settings->api_is_enabled ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?>>
                    <div class="form-group <?= \Altum\Teams::get_main_user()->plan_settings->api_is_enabled ? null : 'container-disabled' ?>">
                        <label for="api_key"><?= l('account_api.api_key') ?></label>
                        <input type="text" id="api_key" name="api_key" value="<?= \Altum\Teams::get_main_user()->api_key ?>" class="form-control" onclick="this.select();" readonly="readonly" />
                    </div>
                </div>
