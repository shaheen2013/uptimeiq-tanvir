...
<div class="ac-wrapper">
    <a href="https://uptimeiq.com/" target="_blank" class="ac-altumcode-link">
        <img src="https://uptimeiq.com/themes/altum/assets/images/altumcode.svg" alt="AltumCode logo" class="ac-altumcode-image" />
        <span><?= $data->product_name . ' by AltumCode' ?></span>
    </a>

    <div class="ac-cta-wrapper">
        <a href="https://uptimeiq.com/contact?subject=<?= 'Questions about ' . $data->product_name ?>" target="_blank" class="ac-secondary">Any questions? ✉️</a>
