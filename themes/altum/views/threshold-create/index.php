...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="custom-breadcrumbs small">
            ...
            <li class="active" aria-current="page"><?= l('threshold_create.breadcrumb') ?></li>
        </ol>
    </nav>

    <h1 class="h4 text-truncate"><?= l('threshold_create.header') ?></h1>
    <p></p>
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-row">
                    <div class="form-group col">
                        ...
                        <input type="number" min="1" step="1" id="threshold_breach_value" name="threshold_breach_value" class="form-control" value="<?= $data->values['threshold_breach_value'] ?>" disabled />
                    ...
                    <div class="form-group col">
                        ...
                        <select id="threshold_breach_value_type" name="threshold_breach_value_type" class="form-control">
                            <option value="above" <?= $data->values['threshold_breach_value_type'] == 'above' ? 'selected="selected"' : null ?>><?= l('global.threshold_breach.above') ?></option>
                            <option value="below" <?= $data->values['threshold_breach_value_type'] == 'below' ? 'selected="selected"' : null ?>><?= l('global.threshold_breach.below') ?></option>
                            <option value="none" <?= $data->values['threshold_breach_value_type'] == 'none' ? 'selected="selected"' : null ?>><?= l('global.threshold_breach.none') ?></option>
...
<script>
    'use strict';
    $('#threshold_breach_value_type').change( function () {
        if ($('#threshold_breach_value_type').val()=='none') {
            $('#threshold_breach_value').attr('disabled', 'disabled');
        }else{
            $('#threshold_breach_value').removeAttr('disabled');
        }
    });
