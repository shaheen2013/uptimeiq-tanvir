        ...
        <div class="row">
            <div class="col-12 col-lg-8 offset-lg-2 d-flex flex-column justify-content-center align-items-center text-center">
                ...
                <div class="d-flex flex-column flex-lg-row mt-5 mb-4">
                    <a href="<?= url('register') ?>" class="btn btn-primary index-button mb-2 mb-lg-0 mr-lg-2"><?= l('index.get_started') ?></a>
                    <a href="<?= url('s/example') ?>" target="_blank" class="btn btn-gray-100 index-button mb-2 mb-lg-0"><?= l('index.example') ?> <i class="fa fa-fw fa-xs fa-external-link-alt"></i></a>
                </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card bg-gray-50 border-0 mb-4 position-relative">
                <div class="card-body">
                    ...
                    <span class="text-muted"><?= l('index.monitors.subheader') ?></span>
                </div>
            </div>
            ...
            <div class="card bg-gray-50 border-0 mb-4 position-relative">
                <div class="card-body">
                    ...
                    <span class="text-muted"><?= l('index.heartbeats.subheader') ?></span>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="mb-2">
                        <i class="fa fa-fw fa-wifi mr-1"></i> <a href="#tab-status-pages" class="h5 text-blue-500 stretched-link text-decoration-none">
                            <?= l('index.status_pages.header') ?>
                        </a>
                    </div>
                    <span class="text-muted"><?= l('index.status_pages.subheader') ?></span>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="mb-2">
                        <i class="fa fa-fw fa-times mr-1"></i> <a href="#tab-incidents" class="h5 text-blue-500 stretched-link text-decoration-none">
                            <?= l('index.incidents.header') ?>
                        </a>
                    </div>
                    <span class="text-muted"><?= l('index.incidents.subheader') ?></span>
                </div>
            </div>
        </div>
    ...
    <div class="bg-blue-50 py-6">
        <div class="container">
            <div class="d-flex flex-column flex-lg-row justify-content-around align-items-lg-center">
                <div>
                    <h2 class="text-blue-900"><?= l('index.cta.header') ?></h2>
                    <p class="text-blue-800"><?= l('index.cta.subheader') ?></p>
                </div>
