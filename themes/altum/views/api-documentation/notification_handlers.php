...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="custom-breadcrumbs small">
            ...
            <li class="active" aria-current="page"><?= l('api_documentation.notification_handlers.breadcrumb') ?></li>
        </ol>
    </nav>

    <h1 class="h4 mb-4"><?= l('api_documentation.notification_handlers.header') ?></h1>
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.allowed_values'), '<code>' . implode('</code> , <code>',  require APP_PATH . 'includes/notification_handlers.php') . '</code>') ?></td>
                            </tr>
                            <tr>
                                <td>email</td>
                                <td>
                                ...
                                <td>(type=email) <?= l('notification_handlers.input.email') ?></td>
                            </tr>
                            <tr>
                                <td>webhook</td>
                                <td>
                                ...
                                <td>(type=webhook) <?= l('notification_handlers.input.webhook') ?></td>
                            </tr>
                            <tr>
                                <td>slack</td>
                                <td>
                                ...
                                <td>(type=slack) <?= l('notification_handlers.input.slack') ?></td>
                            </tr>
                            <tr>
                                <td>discord</td>
                                <td>
                                ...
                                <td>(type=discord) <?= l('notification_handlers.input.discord') ?></td>
                            </tr>
                            <tr>
                                <td>telegram</td>
                                <td>
                                ...
                                <td>(type=telegram) <?= l('notification_handlers.input.telegram') ?></td>
                            </tr>
                            <tr>
                                ...
                                <td>(type=telegram) <?= l('notification_handlers.input.telegram_chat_id') ?></td>
                            </tr>
                            <?php if(settings()->monitors_heartbeats->twilio_notifications_is_enabled): ?>
                                <tr>
                                    ...
                                    <td>(type=twilio) <?= l('notification_handlers.input.twilio') ?></td>
                                </tr>
                            <?php endif ?>
                            </tbody>
                        </table>
