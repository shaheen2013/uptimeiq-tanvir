            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" class="form-control <?= \Altum\Alerts::has_field_errors('name') ? 'is-invalid' : null ?>" value="<?= \Altum\Teams::get_main_user()->name ?>" maxlength="32" />
                        <?= \Altum\Alerts::output_field_error('name') ?>
                    </div>

                    <div class="form-group">
                        <label for="email"><?= l('account.settings.email') ?></label>
                        <input type="text" id="email" name="email" class="form-control <?= \Altum\Alerts::has_field_errors('email') ? 'is-invalid' : null ?>" value="<?= \Altum\Teams::get_main_user()->email ?>" maxlength="128" />
                    ...
                    <div class="form-group">
                        ...
                        <select id="timezone" name="timezone" class="form-control">
                            <?php foreach(DateTimeZone::listIdentifiers() as $timezone) echo '<option value="' . $timezone . '" ' . (\Altum\Teams::get_main_user()->timezone == $timezone ? 'selected="selected"' : null) . '>' . $timezone . '</option>' ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="anti_phishing_code" name="anti_phishing_code" class="form-control <?= \Altum\Alerts::has_field_errors('anti_phishing_code') ? 'is-invalid' : null ?>" value="<?= \Altum\Teams::get_main_user()->anti_phishing_code ?>" maxlength="8" />
        ...
        <div class="" id="billing" style="<?= !settings()->payment->is_enabled || !settings()->payment->taxes_and_billing_is_enabled ? 'display: none;' : null ?>">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php if(!empty(\Altum\Teams::get_main_user()->payment_subscription_id)): ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select id="billing_type" name="billing_type" class="form-control">
                                    <option value="personal" <?= \Altum\Teams::get_main_user()->billing->type == 'personal' ? 'selected="selected"' : null ?>><?= l('account.billing.type_personal') ?></option>
                                    <option value="business" <?= \Altum\Teams::get_main_user()->billing->type == 'business' ? 'selected="selected"' : null ?>><?= l('account.billing.type_business') ?></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input id="billing_name" type="text" name="billing_name" class="form-control" value="<?= \Altum\Teams::get_main_user()->billing->name ?>" />
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input id="billing_address" type="text" name="billing_address" class="form-control" value="<?= \Altum\Teams::get_main_user()->billing->address ?>" />
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="billing_city" type="text" name="billing_city" class="form-control" value="<?= \Altum\Teams::get_main_user()->billing->city ?>" />
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="billing_county" type="text" name="billing_county" class="form-control" value="<?= \Altum\Teams::get_main_user()->billing->county ?>" />
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-2">
                            <div class="form-group">
                                ...
                                <input id="billing_zip" type="text" name="billing_zip" class="form-control" value="<?= \Altum\Teams::get_main_user()->billing->zip ?>" />
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="billing_country" name="billing_country" class="form-control">
                                    <?php foreach(get_countries_array() as $key => $value): ?>
                                        <option value="<?= $key ?>" <?= \Altum\Teams::get_main_user()->billing->country == $key ? 'selected="selected"' : null ?>><?= $value ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input id="billing_phone" type="text" name="billing_phone" class="form-control" value="<?= \Altum\Teams::get_main_user()->billing->phone ?>" />
                            </div>
                        </div>
                        ...
                        <div class="col-12" id="billing_tax_id_container">
                            <div class="form-group">
                                ...
                                <input id="billing_tax_id" type="text" name="billing_tax_id" class="form-control" value="<?= \Altum\Teams::get_main_user()->billing->tax_id ?>" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select id="twofa_is_enabled" name="twofa_is_enabled" class="form-control <?= \Altum\Alerts::has_field_errors('twofa_token') ? 'is-invalid' : null ?>">
                            <option value="1" <?= \Altum\Teams::get_main_user()->twofa_secret ? 'selected="selected"' : null ?>><?= l('global.yes') ?></option>
                            <option value="0" <?= !\Altum\Teams::get_main_user()->twofa_secret ? 'selected="selected"' : null ?>><?= l('global.no') ?></option>
                        </select>
                    </div>

                    <div id="twofa_container">
                        <?php if(!\Altum\Teams::get_main_user()->twofa_secret): ?>
                            <div class="form-group">
