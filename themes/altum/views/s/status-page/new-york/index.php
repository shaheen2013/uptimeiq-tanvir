            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <?php if($data->monitors_status): ?>
                        ...
                        <div class="ml-3">
                            <span class="text-white h3"><?= l('s_status_page.monitors_status_ok') ?></span>
                        </div>
                    <?php else: ?>
                        <div class="svg-head-status text-danger d-inline-block"><?= include_view(ASSETS_PATH . '/images/s/x-circle.svg') ?></div>
                        <div class="ml-3">
                            <span class="text-white h3"><?= l('s_status_page.monitors_status_not_ok') ?></span>
                        </div>
                    <?php endif ?>
                </div>
            </div>
                ...
                <div class="card my-4">
                    <div class="card-body">
                            ...
                            <div class="d-flex flex-column flex-lg-row justify-content-between">
                                ...
                                <div class="d-flex flex-column">
                                    <div>
                                        ...
                                        <span class="text-muted"><?= sprintf(l('s_status_page.total_not_ok_checks'), nr($monitor->monitor_logs_data['total_not_ok_checks'])) ?></span>
                                    </div>
                                    <div>
                        ...
                        <?php else: ?>
                            ...
                            <div class="small text-muted mt-2"><?= l('s_status_page.no_monitor_logs') ?></div>
                        <?php endif ?>
