        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="custom_not_found_url" name="custom_not_found_url" class="form-control" value="<?= $data->values['custom_index_url'] ?>" placeholder="<?= l('domains.input.custom_not_found_url_placeholder') ?>" />
