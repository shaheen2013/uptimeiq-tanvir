        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex justify-content-between mb-3">
                    <h5 class="modal-title"><i class="fa fa-fw fa-sm fa-trash-alt text-primary-900 mr-2"></i> <?= l('admin_team_delete_modal.header') ?></h5>
...
<script>
    ...
    $('#team_delete_modal').on('show.bs.modal', event => {
        ...
        $(event.currentTarget).find('#team_delete_url').attr('href', `${url}sub-admin/teams/delete/${team_id}&global_token=${global_token}`);
    });
</script>
