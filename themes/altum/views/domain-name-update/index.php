...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h1 class="h4 text-truncate mb-0"><?= sprintf(l('domain_name_update.header'), $data->domain_name->name) ?></h1>
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group custom-control custom-switch">
                    ...
                    <small class="form-text text-muted"><?= l('domain_name.input.is_enabled_help') ?></small>
                </div>
