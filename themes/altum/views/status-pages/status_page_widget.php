        ...
        <div class="card-body d-flex flex-column justify-content-between">
            ...
            <div class="text-truncate">
                <small class="text-muted">
                    ...
                    <a href="<?= $data->status_page->full_url ?>" class="text-muted" target="_blank" rel="noreferrer"><?= remove_url_protocol_from_url($data->status_page->full_url) ?></a>
                </small>
            </div>

            <div>
                <small class="text-muted">
                    <i class="fa fa-fw fa-sm fa-chart-bar text-muted mr-1"></i>

                    <a href="<?= url('status-page-statistics/' . $data->status_page->status_page_id) ?>" class="text-muted"><?= sprintf(l('status_pages.pageviews'), nr($data->status_page->pageviews)) ?></a>
                </small>
            </div>
        </div>
    </div>
