...
$(document).on('change','.user_role', function () {
    ...
    $("#roleChangeConfirm").attr("user_id", user_id);
    $("#roleChangeConfirm").attr("role_id", role_id);
    $('#roleChangeConfirm').modal('show');
});

$(document).on('click','#roleChangeModalConfirm', function () {
    var sent_data={
        user_id: $("#roleChangeConfirm").attr("user_id"),
        role_id: $("#roleChangeConfirm").attr("role_id"),
    }
