...
return [
    ...
    'admin_plans.plan.monitors_limit' => 'Monitors limit',
    'admin_plans.plan.monitors_check_intervals' => 'Monitors check intervals',
    'admin_plans.plan.heartbeats_limit' => 'Heartbeats limit',
    'admin_plans.plan.thresholds_limit' => 'Thresholds limit',
    ...
    'admin_plans.plan.notification_handlers_email_limit' => 'Emails',
    'admin_plans.plan.notification_handlers_webhook_limit' => 'Webhook',
    'admin_plans.plan.notification_handlers_slack_limit' => 'Slack',
    'admin_plans.plan.notification_handlers_discord_limit' => 'Discord',
    'admin_plans.plan.notification_handlers_twilio_limit' => 'Twilio',
    'admin_plans.plan.notification_handlers_telegram_limit' => 'Telegram',
    'admin_plans.plan.logs_retention' => 'Monitors & heartbeats logs retention',
    'admin_plans.plan.logs_retention_help' => 'How many days will the history logs for monitors & heartbeats be kept in the database.',
    ...
    'admin_user_view.monitors' => 'Monitors',
    'admin_user_view.heartbeats' => 'Heartbeats',
    'admin_user_view.domain_names' => 'Domain names',
    'admin_user_view.projects' => 'Projects',
    'admin_user_view.status_pages' => 'Status pages',
    'admin_user_view.payments' => 'Payments',
    'admin_user_view.domains' => 'Custom Domains',
    'admin_user_view.notification_handlers' => 'Notification handlers',
    ...
    'admin_settings.documentation' => 'Read the <a href="https://altumco.de/66uptime-docs" target="_blank">Documentation</a> to get more details on certain available configurations.',
    ...
    'admin_settings.cron.monitors' => 'Monitors tracking cron job',
    ...
    'admin_settings.cron.monitors_email_reports' => 'Monitors email reports cron job',
    ...
    'admin_settings.support.status.active.help' => 'You are eligible for receiving support via support@uptimeiq.com',
    ...
    'admin_settings.status_pages.logo_size_limit' => 'Status pages logo size limit (MB)',
    'admin_settings.status_pages.favicon_size_limit' => 'Status pages favicon size limit (MB)',
    'admin_settings.status_pages.opengraph_size_limit' => 'Status pages opengraph size limit (MB)',
    'admin_settings.status_pages.size_limit_help' => 'You are not able to set a higher limit than your actual server upload limit.',
    ...
    'admin_settings.monitors_heartbeats.tab' => 'Monitors & Heartbeats',
    'admin_settings.monitors_heartbeats.email_reports_is_enabled' => 'Email reports system',
    ...
    'admin_settings.monitors_heartbeats.email_reports_is_enabled_help' => 'Enabling the email reports will give your users the ability to get email reports of their monitors. Make sure to have a proper email sending configuration via the SMTP tab.',
    'admin_settings.monitors_heartbeats.monitors_ping_method' => 'Monitors ping method',
    'admin_settings.monitors_heartbeats.monitors_ping_method_help' => 'ping - fastest and most efficient way, requires access to exec() command. fsockopen - alternative for when the exec() command is not allowed.',
    'admin_settings.monitors_heartbeats.twilio_notifications_is_enabled' => 'Enable Twilio SMS notifications',
    'admin_settings.monitors_heartbeats.twilio_sid' => 'Twilio account SID',
    'admin_settings.monitors_heartbeats.twilio_token' => 'Twilio account token',
    'admin_settings.monitors_heartbeats.twilio_number' => 'Twilio phone number',
    ...
    'admin_statistics.monitors.menu' => 'Monitors',
    'admin_statistics.monitors.header' => 'Monitors',
    'admin_statistics.monitors.chart' => 'New monitors',

    'admin_statistics.monitors_logs.menu' => 'Monitors checks',
    'admin_statistics.monitors_logs.header' => 'Monitors checks',
    'admin_statistics.monitors_logs.chart' => 'Checks',

    'admin_statistics.heartbeats.menu' => 'Heartbeats',
    'admin_statistics.heartbeats.header' => 'Heartbeats',
    'admin_statistics.heartbeats.chart' => 'New heartbeats',

    'admin_statistics.domain_names.menu' => 'Domain names',
    'admin_statistics.domain_names.header' => 'Domain names',
    'admin_statistics.domain_names.chart' => 'New domain names',
    ...
    'admin_statistics.status_pages.menu' => 'Status pages',
    'admin_statistics.status_pages.header' => 'Status pages',
    'admin_statistics.status_pages.chart' => 'New status pages',

    'admin_statistics.notification_handlers.menu' => 'Notif. handlers',
    'admin_statistics.notification_handlers.header' => 'Notification handlers',
    'admin_statistics.notification_handlers.chart' => 'New notification handlers',
    ...
    'admin_notification_handlers.table.user' => 'User',
    'admin_notification_handlers.table.name' => 'Name',
    'admin_notification_handlers.table.type' => 'Type',
    'admin_notification_handlers.table.is_enabled' => 'Status',


    'admin_monitors.title' => 'Monitors',
    'admin_monitors.header' => 'Monitors',
    'admin_monitors.menu' => 'Monitors',

    'admin_monitors.table.user' => 'User',
    'admin_monitors.table.monitor' => 'Monitor',
    'admin_monitors.table.stats' => 'Stats',
    'admin_monitors.table.is_enabled' => 'Status',
    'admin_monitors.table.average_response_time' => '%s avg. response time',
    'admin_monitors.table.uptime' => '%s uptime',
    'admin_monitors.table.name' => 'Name',

    'admin_monitors.filters.type' => 'Monitor type',
    'admin_monitors.filters.type_website' => 'Website',
    'admin_monitors.filters.type_ping' => 'Ping',
    'admin_monitors.filters.type_port' => 'Port',
    'admin_monitors.filters.search_by_target' => 'Website URL/Host',
    'admin_monitors.filters.order_by_last_check_datetime' => 'Last checked datetime',
    'admin_monitors.filters.order_by_uptime' => 'Uptime',
    'admin_monitors.filters.order_by_average_response_time' => 'Response time',

    // Threshold language entry begin
    'admin_thresholds.title' => 'Thresholds',
    'admin_thresholds.header' => 'Thresholds',
    'admin_thresholds.menu' => 'Thresholds',
    
    'admin_thresholds.table.user' => 'User',
    'admin_thresholds.table.name' => 'Name',
    'admin_thresholds.table.stats' => 'Stats',
    'admin_thresholds.table.is_enabled' => 'Status',
    'admin_thresholds.table.uptime' => '%s uptime',
    
    'admin_thresholds.filters.order_by_last_run_datetime' => 'Last run datetime',
    'admin_thresholds.filters.order_by_uptime' => 'Uptime',
    // Threshold language entry end
    
    'admin_heartbeats.title' => 'Heartbeats',
    'admin_heartbeats.header' => 'Heartbeats',
    'admin_heartbeats.menu' => 'Heartbeats',

    'admin_heartbeats.table.user' => 'User',
    'admin_heartbeats.table.name' => 'Name',
    'admin_heartbeats.table.stats' => 'Stats',
    'admin_heartbeats.table.is_enabled' => 'Status',
    'admin_heartbeats.table.uptime' => '%s uptime',

    'admin_heartbeats.filters.order_by_last_run_datetime' => 'Last run datetime',
    'admin_heartbeats.filters.order_by_uptime' => 'Uptime',
    ...
    'admin_domain_names.table.user' => 'User',
    'admin_domain_names.table.domain_name' => 'Domain name',
    'admin_domain_names.table.is_enabled' => 'Status',
    ...
    'admin_ping_servers.table.monitors' => 'Monitors',
    'admin_ping_servers.table.is_enabled' => 'Status',
