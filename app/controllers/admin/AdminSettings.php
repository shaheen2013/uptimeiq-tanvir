...
class AdminSettings extends Controller {
    ...
    public function support() {
        ...
        if(!empty($_POST) && !empty($_POST['new_key'])) {
            ...
            $altumcode_api = 'https://api2.uptimeiq.com/validate-support-extension';
    ...
    public function monitors_heartbeats() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['twilio_notifications_is_enabled'] = (bool) $_POST['twilio_notifications_is_enabled'];
            ...
            $value = json_encode([
                ...
                'twilio_notifications_is_enabled' => $_POST['twilio_notifications_is_enabled'],
