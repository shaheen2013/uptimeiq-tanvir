...
class ApiNotificationHandlers extends Controller {
    ...
    private function post() {
        ...
        /* Clear the cache */
        \Altum\Cache::$adapter->deleteItem('notification_handlers?user_id=' . $this->api_user->user_id);
    ...
    private function patch() {
        ...
        $_POST['is_enabled'] = (int) $_POST['is_enabled'] ?? $notification_handler->is_enabled;
