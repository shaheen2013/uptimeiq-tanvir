...
class Authentication
{
    ...
    public static function is_admin()
    {
        ...
        return \Altum\Teams::get_main_user()->type == 1;
    }

    public static function is_sub_admin()
    {
    ...
    public static function is_operator()
    {
        if (\Altum\Teams::get_main_user()->type == 3) {
            return true;
        } else {
            return false;
        }
    ...
    {
        if (\Altum\Teams::get_main_user()->type == 4) {
            return true;
        } else {
            return false;
        }
