...
class Controller {
    ...
    public function run() {
        ...
        if(\Altum\Router::$path == 'sub-admin') {
            /* Establish the side menu view */
            $sidebar = new \Altum\View('sub-admin/partials/sub_admin_sidebar', (array) $this);
            $this->add_view_content('sub_admin_sidebar', $sidebar->run());

            /* Establish the top menu view */
            $menu = new \Altum\View('sub-admin/partials/sub_admin_menu', (array) $this);
            $this->add_view_content('sub_admin_menu', $menu->run());

            /* Establish the footer view */
            $footer = new \Altum\View('sub-admin/partials/footer', (array) $this);
            $this->add_view_content('footer', $footer->run());

            $wrapper = new \Altum\View('sub-admin/wrapper', (array) $this);
        }
