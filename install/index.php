                        ...
                        <section id="requirements" style="display: none">
                            ...
                            <div class="table-responsive table-custom-container mt-5">
                                <table class="table table-custom">
                                    ...
                                    <tbody>
                                    <?php foreach(['config.php', 'uploads/main/', 'uploads/cache/', 'uploads/offline_payment_proofs/', 'uploads/blog/', 'uploads/status_pages_favicons/', 'uploads/status_pages_logos/', 'uploads/status_pages_opengraph/'] as $key): ?>
                                        <tr>
                                            <td>/<?= $key ?></td>
